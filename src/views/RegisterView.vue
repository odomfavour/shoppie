...
// Watch for changes in password and confirmPass refs
// watch([password, confirmPass], () => {
//   passwordsMismatch.value = password.value !== confirmPass.value;
//  });
</script>
...
<template>
  <div class="font-poppins">
    <div class="flex">
      <div
        class="md:w-2/5 md:block hidden bg-reg-pattern h-screen bg-cover p-10"
      >
      ...
      >
        <div class="md:w-2/3 w-11/12">
          <div
            class="p-3 bg-slate-500 rounded-full w-12 h-12 flex justify-center items-center cursor-pointer mb-10"
          >
            <router-link to="/">
              <BIconChevronBarLeft class="text-white" />
            </router-link>
          </div>
          <h3 class="text-3xl mb-4 font-extrabold">Register</h3>
